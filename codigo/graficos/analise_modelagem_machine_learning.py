...
# --- Feature Engineering: Criar a variável 'Regiao' e outras ---
mapa_uf_para_nome = {
...
def analisar_grupo(df_grupo, nome_grupo):
    ...
    param_dist = {
        ...
        'classifier__max_depth': [3, 5, 7, 9], 'classifier__subsample': [0.7, 0.8, 0.9, 1.0],
        'classifier__colsample_bytree': [0.7, 0.8, 0.9, 1.0]
    }
    random_search = RandomizedSearchCV(
        pipeline, param_distributions=param_dist, n_iter=50, scoring='accuracy',
